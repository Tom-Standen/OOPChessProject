...
void board::init(){
	...
	for (int col = 0; col < board_cols; col++){
		((col % 2 == 0) ? //if col == even: White square, if not : Black square
			m_square_2Dvector[1][col] = square("White", pawn("White")) :
			m_square_2Dvector[1][col] = square("Black", pawn("White")));
	}
	//Set black pawns on second last row
	for (int col = 0; col < board_cols; col++){
		((col % 2 == 0) ? //if col == even: Black square, if not : White square
			m_square_2Dvector[6][col] = square("Black", pawn("Black")) :
			m_square_2Dvector[6][col] = square("White", pawn("Black")));
	}
	//Set white pieces on first row 
	m_square_2Dvector[0][0] = square("Black", rook("White"));
	m_square_2Dvector[0][1] = square("White", knight("White"));
	m_square_2Dvector[0][2] = square("Black", bishop("White"));
	m_square_2Dvector[0][3] = square("White", queen("White"));
	m_square_2Dvector[0][4] = square("Black", king("White"));
	m_square_2Dvector[0][5] = square("White", bishop("White"));
	m_square_2Dvector[0][6] = square("Black", knight("White"));
	m_square_2Dvector[0][7] = square("White", rook("White"));
	//Setet black pieces on last row
	m_square_2Dvector[7][0] = square("White", rook("Black"));
	m_square_2Dvector[7][1] = square("Black", knight("Black"));
	m_square_2Dvector[7][2] = square("White", bishop("Black"));
	m_square_2Dvector[7][3] = square("Black", queen("Black"));
	m_square_2Dvector[7][4] = square("White", king("Black"));
	m_square_2Dvector[7][5] = square("Black", bishop("Black"));
	m_square_2Dvector[7][6] = square("White", knight("Black"));
	m_square_2Dvector[7][7] = square("Black", rook("Black"));
